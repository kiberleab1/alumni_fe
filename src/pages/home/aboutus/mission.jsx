    ...
    <div className="bg-gray-100 min-h-screen w-full flex flex-col items-center justify-center p-4 space-y-6">
      <div className="flex flex-wrap justify-center w-full space-y-6 md:space-y-0 md:space-x-6">
        {[
          ...
          <div
            key={index}
            className="zoom-card mx-4 md:mx-0 w-full sm:w-[90%] md:w-[45%] lg:w-[30%] h-auto sm:h-72 md:h-96 rounded-2xl bg-gray-200 bg-opacity-70 p-6 m-2 shadow-lg transition-transform duration-300 ease-in-out"
            data-aos="zoom-in"
      ...
      <div className="w-full flex justify-center mt-6">
        <div
          ...
          data-aos-offset="200"
        >
          <div className="flex flex-col items-center justify-center h-full p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-gray-100 duration-300 rounded">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded-full shadow-md ">
