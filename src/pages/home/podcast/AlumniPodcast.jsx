...
const AlumniPodcast = () => {
  return (
    <div className="min-h-screen  flex space-x-18  flex-wrap gap-4 space-x-8  items-center justify-center text-black ">
        ...
        return (
          <div className="flex space-x-36     items-center justify-center text-black  m-1 ">
            <div
              ...
              style={{ boxShadow: "-50px 30px #7c7d7c" }}
            >
              <div
                className="max-h-lg  rounded-xl max-w-lg bg-gray-900 p-2"
                style={{ boxShadow: "60px -40px #ebf0f0" }}
              >
                <iframe
                  // width="500"
                  height="315"
