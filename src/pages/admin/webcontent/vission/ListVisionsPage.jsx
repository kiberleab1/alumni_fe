...
export default function AdminListVisionPage({
  onCreateVisionPage,
  onEditVisionPage,
}) {
  const { isError, data, isLoading } = useQuery(
    "getAllVisionComponent",
    async () => {
    ...
    <QueryResult isError={isError} isLoading={isLoading} data={data}>
      <div>
        <ListVision
          ...
          onCreateVisionPage={onCreateVisionPage}
          onEditPodcastClick={onEditVisionPage}
        />
      </div>
    </QueryResult>
  );
...
function ListVision({ webContent, onCreateVisionPage, onEditPodcastClick }) {
  ...
  // Mutation for deleting a Vision
  ...
  const confirmDeletion = () => {
    console.log(selectedVision);
    if (selectedVision && selectedVision.id) {
      console.log;
      mutate.mutate({ id: selectedVision.id.toString() });
    }
  };
    ...
    <div className="flex flex-col">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-500 font-mono">
            A list of all the Vision in the system including their name,
                    ...
                    <tr key={Vision.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-start text-sm font-medium">
                        <a
                          ...
                          onClick={() => onEditPodcastClick(Vision)}
                        >
                          Edit
                        </a>
                        <a
      ...
      {selectedVision && (
        <Modal
          ...
          message={`Are you sure you want to delete the Vision "${selectedVision.title}"? This action cannot be undone.`}
        />
      )}
    </div>
  );
