...
function CreateOurStoryForm() {
  return (
    <>
      <CreateOurStorageForm />
    </>
  );
}

export default CreateOurStoryForm;

function CreateOurStorageForm() {
        ...
        <Container>
          <Row className="justify-content-center">
            <Col md="7" className="text-center">
              <h1 className="title font-bold">Our story us Page</h1>
