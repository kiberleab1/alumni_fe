...
export default function AdminListAboutUsPage({
  onCreateAboutUsPage,
  onEditAboutusPage,
}) {
  const { isError, data, isLoading } = useQuery(
    "getAllAboutUsComponent",
    async () => {
    ...
    <QueryResult isError={isError} isLoading={isLoading} data={data}>
      <div>
        <ListAboutUs
          ...
          onCreateAboutUsPage={onCreateAboutUsPage}
          onEditPodcastClick={onEditAboutusPage}
        />
      </div>
    </QueryResult>
  );
...
function ListAboutUs({ webContent, onCreateAboutUsPage, onEditPodcastClick }) {
  ...
  // Mutation for deleting a AboutUs
  ...
  const confirmDeletion = () => {
    console.log(selectedAboutUs);
    if (selectedAboutUs && selectedAboutUs.id) {
      console.log;
      mutate.mutate({ id: selectedAboutUs.id.toString() });
    }
  };
    ...
    <div className="flex flex-col">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-500 font-mono">
            A list of all the AboutUs in the system including their name,
                    ...
                    <tr key={AboutUs.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-start text-sm font-medium">
                        <a
                          ...
                          onClick={() => onEditPodcastClick(AboutUs)}
                        >
                          Edit
                        </a>
                        <a
      ...
      {selectedAboutUs && (
        <Modal
          ...
          message={`Are you sure you want to delete the AboutUs "${selectedAboutUs.title}"? This action cannot be undone.`}
        />
      )}
    </div>
  );
