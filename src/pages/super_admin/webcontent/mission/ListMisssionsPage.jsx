...
export default function AdminListMissionPage({
  onCreateMissionPage,
  onEditMissionPage,
}) {
  const { isError, data, isLoading } = useQuery(
    "getAllMissionComponent",
    async () => {
    ...
    <QueryResult isError={isError} isLoading={isLoading} data={data}>
      <div>
        <ListMission
          ...
          onCreateMissionPage={onCreateMissionPage}
          onEditPodcastClick={onEditMissionPage}
        />
      </div>
    </QueryResult>
  );
...
function ListMission({ webContent, onCreateMissionPage, onEditPodcastClick }) {
  ...
  // Mutation for deleting a Mission
  ...
  const confirmDeletion = () => {
    ...
    if (selectedMission && selectedMission.id) {
      console.log;
      mutate.mutate({ id: selectedMission.id.toString() });
    }
  };
    ...
    <div className="flex flex-col">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-500 font-mono">
            A list of all the Mission in the system including their name,
                    ...
                    <tr key={Mission.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-start text-sm font-medium">
                        <a
                          ...
                          onClick={() => onEditPodcastClick(Mission)}
                        >
                          Edit
                        </a>
                        <a
      ...
      {selectedMission && (
        <Modal
          ...
          message={`Are you sure you want to delete the Mission "${selectedMission.title}"? This action cannot be undone.`}
        />
      )}
    </div>
  );
