...
import { updateAlumniProfile, getDepartments, getInstitutes } from "src/api";
...
export default function EditAlumni({ alumni }) {
    ...
    const graduation_yearFormat = formatInputDate(alumni.graduation_year);
    ...
    const [alumniFields, setAlumniFields] = useState({
        id: alumni.id,
        institution_id: alumni.institution_id ? alumni.institution_id : "",
        department_id: alumni.department_id ? alumni.department_id : "",
        graduation_year: graduation_yearFormat ? graduation_yearFormat : "",
        graduation_institute: alumni.graduation_institute ? alumni.graduation_institute : "",
        social_media_links: alumni.social_media_links ? alumni.social_media_links : "",
        certification_link: alumni.certification_link ? alumni.certification_link : "",
        description: alumni.description ? alumni.description : "",
        status: alumni.status ? alumni.status : "",
        achievements: alumni.achievements ? alumni.achievements : "",
        image: null,
        degree: alumni.degree ? alumni.degree : "",
        Skills: alumni.Skills ? alumni.Skills : "",
        disability_status: alumni.disability_status ? alumni.disability_status : "",
        Language: alumni.Language ? alumni.Language : "",
    });
    //scroll anima...
    useEffect(() => {
        AOS.init({
    ...
    const handleImageChange = (e) => {
        setAlumniFields({ ...alumniFields, image: e.target.files[0] });
      };
    ...
    const handleDepartmentSubmit = async (e) => {
        ...
        formData.append("id", alumniFields.id);
        ...
        if (alumniFields.image) {
            formData.append("image", alumniFields.image);
        }

        try {
            const result = await updateAlumniProfile(alumniFields);
