...
const newsdData = [
  ...
  },
  {
    ...
    discription:
      "I'm looking for something that can deliver a 50-pound payload of snow on a small feminine target. Can you suggest something? Hello...?",
    images:
      "https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/pr-sample25.jpg",
  },
  {
    day: "September 14th, 2015",
    headline: "The world ended yesterday",
  ...
  return (
    <QueryResult isLoading={isLoading} isError={isError} data={data}>
      <div className="flex flex-col  bg-gray-20  w-[100%]">
        ...
        <div className="container mx-auto px-1 py-2 sm:px-10 md:px-20 lg:px-52 lg:pt-12 h-[650px] overflow-y-scroll min-w-[100%] ">
