...
import { createAddress, createDepartment, createInstitute, updateJobHistory, getInstitutes } from '../api';
...
export default function EditJobHistory({ jobHistory }) {
    ...
    const handleUpdateJobHistoryClick = async (e) => {
        e.preventDefault();
        if (!jobHistoryFields.title || !jobHistoryFields.description || !jobHistoryFields.status) {
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
                ...
                <form className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-3">
                    <div className="px-4 sm:px-0">
                        <h2 className="text-base font-semibold leading-7 text-gray-900">Job History Information</h2>
                    </div>
                    <div className="px-4 py-6 sm:p-8">
                        <div className="grid max-w-full grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(e) => setJobHistoryFields({ ...jobHistoryFields, title: e.target.value })}
                            ...
                            <div className="sm:col-span-2">
                                <label htmlFor="job-duration" className="block text-sm font-medium leading-6 text-gray-900">
                                    Duration
                                </label>
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(e) => setJobHistoryFields({ ...jobHistoryFields, duration: e.target.value })}
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(e) => setJobHistoryFields({ ...jobHistoryFields, address: e.target.value })}
                                        className="col-span-2 sm:col-span-1 block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                            ...
                            <div className="sm:col-span-6">
                                <label htmlFor="jobHistory-description" className="block text-sm font-medium leading-6 text-gray-900">
                                    Job Description
                                </label>
                                <div className="mt-2">
                                    <textarea
                                        ...
                                        onChange={(e) => setJobHistoryFields({ ...jobHistoryFields, description: e.target.value })}
                                        className="block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                                    ></textarea>
                                </div>
                            </div>
                    ...
                    <div className="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                        ...
                        <button type="button" className="text-sm font-semibold leading-6 text-gray-100" onClick={handleJobHistoryClear}>
                            Clear
                        </button>
                        <button
                            type="button"
