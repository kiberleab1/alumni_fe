...
import { createAddress, getDepartments, getInstitutes, createStaff } from '../api';
...
export default function CreateStaff() {
    ...
    const { isError, data, error, isFetching } = useQuery(
        ...
        async () => {
            try {
                ...
                const departmentData = await getDepartments({pageNumber: 1, pageSize: 10 });
                if(departmentData) {
                    const departmentName = Object.values(departmentData.data.department).map(
                        department => ({
    ...
    const handleInstituteSubmit = async (e) => {
        e.preventDefault();
        if (!staffFields.full_name || !staffFields.title || !staffFields.description) {
        ...
        <div className="space-y-10 divide-y divide-gray-900/10">
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
                <div className="px-4 sm:px-0">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">Please provide updated and accurate address information of the staff</p>
                </div>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
                <div className="px-4 sm:px-0">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">Please make sure every input is correct and accurately describes the staff.</p>
                </div>
                ...
                <form className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                    <div className="px-4 py-6 sm:p-8">
                        <div className="grid max-w-full grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="sm:col-span-2">
                                <label htmlFor="staff-name" className="block text-sm font-medium leading-6 text-gray-900">
                                    Full Name
                                </label>
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, full_name: e.target.value })}
                            ...
                            <div className="sm:col-span-2">
                                <label htmlFor="staff-email" className="block text-sm font-medium leading-6 text-gray-900">
                                    Email
                                </label>
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, email: e.target.value })}
                            ...
                            <div className="sm:col-span-2">
                                <label htmlFor="staff-phone_number" className="block text-sm font-medium leading-6 text-gray-900">
                                    Phone Number
                                </label>
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, phone_number: e.target.value })}
                                        className="col-span-2 sm:col-span-1 block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, title: e.target.value })}
                                        className="col-span-2 sm:col-span-1 block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                                        placeholder="Title"
                                    />
                                </div>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <select
                                        ...
                                        onChange={(e) => setDepartmentFields({ ...staffFields, institute_id: e.target.value })}
                            ...
                            <div className="sm:col-span-6">
                                <label htmlFor="staff-description" className="block text-sm font-medium leading-6 text-gray-900">
                                    Staff Description
                                </label>
                                <div className="mt-2">
                                    <textarea
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, description: e.target.value })}
                                        className="block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                                    ></textarea>
                                </div>
                            </div>
                            <div className="sm:col-span-6">
                                <label htmlFor="staff-contact-info" className="block text-sm font-medium leading-6 text-gray-900">
                                    Staff Contact Info
                                </label>
                                <div className="mt-2 grid grid-cols-2 gap-4 sm:grid-cols-3">
                                    <input
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, twitter: e.target.value })}
                                        className="col-span-2 sm:col-span-1 block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, linkedin: e.target.value })}
                                        className="col-span-2 sm:col-span-1 block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, telegram: e.target.value })}
                                        className="col-span-2 sm:col-span-1 block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setStaffFields({ ...staffFields, facebook: e.target.value })}
                                        className="col-span-2 sm:col-span-1 block w-full bg-white border-gray-500 rounded-md border-1 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 font-medium font-mono"
                    ...
                    <div className="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                        {staffError && <p className="text-red-600 font-mono">{staffError}</p>}
